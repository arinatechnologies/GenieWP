...
PROMPT;
	...
	private function generate_enhanced_theme( $site_name, $business_type, $tagline, $description, $primary_color, $secondary_color, $theme_slug, $ai_data = null ) {
		...
		// Create navigation menu and default pages
		$this->create_navigation_menu( $theme_slug, $theme_data );
...
HTML;
	...
	/**
	 * Create navigation menu with default pages
	 *
	 * @param string $theme_slug Theme slug.
	 * @param array  $theme_data Theme data.
	 * @return void
	 */
	private function create_navigation_menu( $theme_slug, $theme_data ) {
		// This will be executed after theme activation
		// Store menu data for later creation
		update_option( 'geniewp_pending_menu_' . $theme_slug, $theme_data['navigation'] );
	}
